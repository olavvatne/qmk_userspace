...
// Extend
#define GUI_AE GUI_T(NO_AE)
#define ALT_CIRC ALT_T(KC_CIRC)
#define CTL_RABK CTL_T(KC_RABK)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_EXT] = LAYOUT_split_3x6_3(
      ...
      _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX,                    XXXXXXX, KC_BSPC, KC_TAB,  KC_APP,   KC_PSCR, _______,
  ...
  [_SYM] = LAYOUT_split_3x6_3(
    ...
    [_NUM] = LAYOUT_split_3x6_3(
      ...
      _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX,                     KC_0,    KC_1, KC_2, KC_3,  KC_PSLS, _______,
                                          _______, _______, _______,    _______, _______, _______
      //                                           ^^^^^^^                       ^^^^^^^
  ),
  [_FUNC] = LAYOUT_split_3x6_3(
      ...
      _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX,                    KC_F12, KC_F1, KC_F2, KC_F3,  XXXXXXX, _______,
                                          _______, _______, _______,    _______, _______, _______
  ),
};
